...
+ (void)show {
    ...
    popupView.bgView.frame = CGRectMake(0, 200, [UIScreen mainScreen].bounds.size.width, [UIScreen mainScreen].bounds.size.height - 64);
...
//    [window addSubview:popupView.bgView];
    ...
    popupView.Triangle.frame = CGRectMake([UIScreen mainScreen].bounds.size.width - devicePadding - Trianglewidth * 2, 64 + 2 + 100, Trianglewidth * 2, Trianglewidth * 2);
